...
import { 
  Truck, Package, MapPin, Clock, TrendingUp, ArrowRight, 
  Navigation, Phone, CheckCircle, Star, User, History,
...
const stats = [
  { icon: Package, label: "Pengiriman Hari Ini", value: "8", trend: "+2", color: "from-[#F99912] to-[#C9C9C3]" },
  { icon: Truck, label: "Total Pengiriman", value: "1,234", trend: "+45", color: "from-[#64762C] to-[#424F17]" },
  { icon: Star, label: "Rating", value: "4.9", trend: "+0.1", color: "from-[#F99912] to-[#64762C]" },
  { icon: Clock, label: "Waktu Rata-rata", value: "25 min", trend: "-3 min", color: "from-[#C9C9C3] to-[#F99912]" },
]
...
const deliveryHistory = [
  { id: "DLV-098", customer: "Dewi M.", time: "14:30", status: "completed", rating: 5 },
  { id: "DLV-097", customer: "Eko P.", time: "13:15", status: "completed", rating: 5 },
  { id: "DLV-096", customer: "Fitri R.", time: "11:45", status: "completed", rating: 4 },
]

export default function DriverDashboard() {
  return (
    <DashboardLayout title="Driver Dashboard" menuItems={driverMenuItems}>
        ...
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-[#64762C]/20 via-[#F99912]/10 to-[#424F17]/20 border border-[#64762C]/20 p-6 lg:p-8">
          ...
          <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-2xl font-bold text-foreground">Selamat Bekerja, Driver!</h2>
            ...
            <div className="flex items-center gap-3">
              <div className="px-4 py-2 rounded-xl bg-[#F99912]/20 border border-[#F99912]/30">
                <p className="text-xs text-muted-foreground">Penghasilan Hari Ini</p>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 backdrop-blur-xl bg-card/60 border border-[#F99912]/10 rounded-2xl p-6">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                <h3 className="text-lg font-semibold text-foreground">Pesanan Aktif</h3>
                ...
                >
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                      ...
                      {order.status === 'delivering' ? 'Mengantar' : 
                       order.status === 'pickup' ? 'Ambil Pesanan' : 'Pending'}
                    </span>
                  </div>
                  ...
                  <div className="space-y-2 mb-4">
                    <div className="flex items-center gap-2 text-sm">
                      ...
                      <span className="text-muted-foreground">- {order.items} item</span>
                    </div>
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-border/50">
                    ...
                    <div className="flex gap-2">
                      <Button size="sm" variant="outline" className="h-8 border-[#F99912]/30 hover:bg-[#F99912]/10">
                        <Phone className="w-4 h-4 mr-1" />
                        Telepon
                      </Button>
                      {order.status === 'pickup' ? (
                        <Button size="sm" className="h-8 bg-gradient-to-r from-[#64762C] to-[#424F17] text-foreground">
                          <Package className="w-4 h-4 mr-1" />
                          Ambil
                        </Button>
                      ) : order.status === 'delivering' ? (
                        <Button size="sm" className="h-8 bg-gradient-to-r from-[#F99912] to-[#64762C] text-[#181612]">
            ...
            <div className="backdrop-blur-xl bg-card/60 border border-[#F99912]/10 rounded-2xl p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-3 rounded-xl bg-muted/30">
                  <span className="text-sm text-muted-foreground">Pengiriman Selesai</span>
                  <span className="font-semibold text-foreground">6/8</span>
                </div>
                <div className="flex items-center justify-between p-3 rounded-xl bg-muted/30">
                  <span className="text-sm text-muted-foreground">Jarak Tempuh</span>
                  <span className="font-semibold text-foreground">32.5 km</span>
                </div>
                <div className="flex items-center justify-between p-3 rounded-xl bg-muted/30">
                  <span className="text-sm text-muted-foreground">Tips Diterima</span>
                ...
                {deliveryHistory.map((delivery) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-1">
                      <Star className="w-4 h-4 fill-[#F99912] text-[#F99912]" />
                      <span className="text-sm font-medium text-foreground">{delivery.rating}</span>
                    </div>
                  </div>
                ))}
              </div>
