...
import { 
  Shield, Users, Store, Truck, TrendingUp, ArrowRight, 
  CheckCircle, XCircle, AlertTriangle, BarChart3, FileText, 
  MessageSquare, Eye, Clock, Activity
} from "lucide-react"
import { Button } from "@/components/ui/button"
import Link from "next/link"
import { 
  Home, FileCheck, Package, UserCog, Flag, BookOpen, 
  Settings, PieChart
} from "lucide-react"

const adminMenuItems = [
  { icon: Home, label: "Dashboard", href: "/admin" },
  { icon: FileCheck, label: "Validasi UMKM", href: "/admin/umkm-validation" },
  { icon: Store, label: "Manajemen UMKM", href: "/admin/umkm" },
  { icon: Users, label: "Manajemen User", href: "/admin/users" },
  { icon: Truck, label: "Manajemen Driver", href: "/admin/drivers" },
  { icon: Flag, label: "Moderasi Review", href: "/admin/reviews" },
  { icon: BookOpen, label: "Manajemen Artikel", href: "/admin/articles" },
  { icon: PieChart, label: "Statistik", href: "/admin/statistics" },
  { icon: MessageSquare, label: "Komplain", href: "/admin/complaints" },
  { icon: Settings, label: "Pengaturan", href: "/admin/settings" },
]

const stats = [
  { icon: Users, label: "Total User", value: "12,450", trend: "+234", color: "from-[#F99912] to-[#C9C9C3]" },
  { icon: Store, label: "Total UMKM", value: "548", trend: "+12", color: "from-[#64762C] to-[#424F17]" },
  { icon: Truck, label: "Total Driver", value: "89", trend: "+5", color: "from-[#F99912] to-[#64762C]" },
  { icon: Activity, label: "Transaksi Hari Ini", value: "1,234", trend: "+18%", color: "from-[#C9C9C3] to-[#F99912]" },
]

const pendingUMKM = [
  { id: 1, name: "Toko Kue Lapis Bogor", owner: "Ahmad Susanto", date: "2 jam lalu", docs: 3 },
  { id: 2, name: "Asinan Segar Bu Eni", owner: "Eni Rahayu", date: "5 jam lalu", docs: 2 },
  { id: 3, name: "Kerajinan Bambu Khas", owner: "Bambang Wijaya", date: "1 hari lalu", docs: 4 },
]

const recentComplaints = [
  { id: "CMP-001", user: "Sarah W.", type: "Produk", status: "open", date: "1 jam lalu" },
  { id: "CMP-002", user: "Budi A.", type: "Pengiriman", status: "in-progress", date: "3 jam lalu" },
  { id: "CMP-003", user: "Citra N.", type: "Refund", status: "resolved", date: "1 hari lalu" },
]
    ...
    <DashboardLayout title="Admin Dashboard" menuItems={adminMenuItems}>
      <div className="space-y-8">
          ...
          <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Kelola seluruh sistem JOSJIS dari sini</p>
              </div>
            </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 backdrop-blur-xl bg-card/60 border border-[#F99912]/10 rounded-2xl p-6">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                <h3 className="text-lg font-semibold text-foreground">Validasi UMKM Pending</h3>
              ...
              {pendingUMKM.map((umkm) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-muted-foreground">{umkm.owner} - {umkm.docs} dokumen</p>
                  </div>
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button size="sm" className="h-8 bg-[#64762C] hover:bg-[#64762C]/90 text-foreground">
          ...
          <div className="backdrop-blur-xl bg-card/60 border border-[#F99912]/10 rounded-2xl p-6">
            <h3 className="text-lg font-semibold text-foreground mb-6">Statistik Sistem</h3>
            <div className="space-y-4">
              {systemStats.map((stat, index) => (
                <div key={index} className="p-4 rounded-xl bg-muted/30">
                  <div className="flex items-center justify-between mb-2">
                    <p className="text-sm text-muted-foreground">{stat.label}</p>
                    <span className="text-xs text-[#64762C] font-medium">{stat.change}</span>
                  </div>
        ...
        <div className="backdrop-blur-xl bg-card/60 border border-[#F99912]/10 rounded-2xl p-6">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              <h3 className="text-lg font-semibold text-foreground">Komplain Terbaru</h3>
            ...
            {recentComplaints.map((complaint) => (
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  <span className="text-sm font-medium text-foreground">{complaint.id}</span>
                ...
                <p className="text-sm text-muted-foreground mb-1">{complaint.user}</p>
                <div className="flex items-center justify-between">
                  <span className="text-xs text-muted-foreground">{complaint.type}</span>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            { icon: FileCheck, label: "Validasi UMKM", href: "/admin/umkm-validation", color: "from-[#64762C] to-[#424F17]" },
            { icon: Flag, label: "Moderasi Review", href: "/admin/reviews", color: "from-[#F99912] to-[#C9C9C3]" },
            { icon: BarChart3, label: "Laporan", href: "/admin/statistics", color: "from-[#C9C9C3] to-[#64762C]" },
            { icon: AlertTriangle, label: "Komplain", href: "/admin/complaints", color: "from-[#F99912] to-[#64762C]" },
          ].map((action, index) => (
