          ...
          <CardContent className="pt-2">
            <div className="h-[320px]">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={dummySalesSeries}>
                  ...
                  />
                  <Bar dataKey="value" fill="#F99912" radius={[10, 10, 0, 0]} />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </CardContent>
        ...
        <Card className="rounded-2xl border-[#F99912]/10 bg-card/60 backdrop-blur-xl">
          ...
          <CardContent className="space-y-3">
            <div className="rounded-2xl border border-[#F99912]/15 bg-[#F99912]/5 p-4">
              ...
              <Link href="/admin/validasi" className="mt-3 inline-flex">
            ...
            <div className="rounded-2xl border border-destructive/20 bg-destructive/5 p-4">
              ...
              <Link href="/admin/laporan" className="mt-3 inline-flex">
                <Button variant="outline" className="rounded-2xl border-border/60">
                  Buka Laporan
                  <ArrowRight className="ml-2 size-4" />
                </Button>
