...
import { 
  BookOpen, Search, Clock, User, ArrowRight, 
  Heart, Share2, Eye, TrendingUp
} from "lucide-react"
...
const articles = [
  {
    ...
    excerpt: "Talas Bogor merupakan salah satu komoditas unggulan yang menjadi identitas kuliner khas Bogor. Simak sejarah dan cara pengolahannya.",
    category: "Kuliner",
    author: "Tim JOSJIS",
    date: "10 Mar 2026",
    readTime: "5 menit",
  ...
  },
  {
    ...
    excerpt: "Panduan lengkap untuk pelaku UMKM yang ingin go digital. Dari strategi pemasaran hingga pengelolaan toko online.",
    category: "Bisnis",
    author: "Admin JOSJIS",
    date: "8 Mar 2026",
    readTime: "8 menit",
  ...
  },
  {
    ...
    excerpt: "Jelajahi destinasi kuliner terbaik di Kota Bogor. Dari makanan tradisional hingga modern yang sayang untuk dilewatkan.",
    category: "Wisata",
  ...
  },
  {
    ...
    excerpt: "Strategi dan tips untuk mengumpulkan Koin Asli Bogor melalui game Harvest Bogor dan quest harian.",
    category: "Tips",
    author: "Tim JOSJIS",
    date: "3 Mar 2026",
    readTime: "4 menit",
  ...
  },
  {
    ...
    excerpt: "Kisah inspiratif perjalanan Roti Unyil Venus yang kini menjadi oleh-oleh wajib dari Kota Bogor.",
    category: "Kuliner",
    author: "Kontributor",
    date: "1 Mar 2026",
    readTime: "7 menit",
  ...
  },
  {
    ...
    excerpt: "Ikuti program pelatihan gratis dari JOSJIS untuk mengembangkan bisnis UMKM Anda ke level selanjutnya.",
    category: "Edukasi",
    author: "Tim JOSJIS",
    date: "28 Feb 2026",
    readTime: "5 menit",
    ...
    <DashboardLayout role="user">
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Baca artikel menarik seputar UMKM dan kuliner Bogor</p>
        </div>
            ...
            {featuredArticles.map((article) => (
              ...
              >
                ...
                <CardContent className="p-6">
                  <Badge variant="secondary" className="mb-3 bg-[#64762C]/20 text-[#64762C]">
                    {article.category}
                  </Badge>
              ...
              <CardContent className="p-6 flex gap-6">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-2">
                    <Badge variant="secondary" className="bg-[#64762C]/20 text-[#64762C] text-xs">
                      {article.category}
                    </Badge>
                ...
                <div className="flex flex-col justify-center gap-2">
                  <Button variant="ghost" size="icon" className="hover:bg-[#F99912]/10 hover:text-[#F99912]">
        ...
        {filteredArticles.length === 0 && (
          <Card className="bg-card/50 backdrop-blur border-[#F99912]/10">
            <CardContent className="p-12 text-center">
              ...
              <h3 className="text-lg font-medium text-foreground mb-2">Artikel tidak ditemukan</h3>
