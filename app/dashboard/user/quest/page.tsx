...
import { 
  Trophy, Star, Zap, Gift, CheckCircle, Clock, 
  ShoppingBag, MessageSquare, Share2, Eye, Heart, 
  Sparkles, Medal, Crown, Target
} from "lucide-react"

// Mock quests data
const dailyQuests = [
  { id: 1, title: "Login Harian", description: "Login ke aplikasi hari ini", xp: 50, progress: 100, completed: true, icon: CheckCircle },
  { id: 2, title: "Review Produk", description: "Berikan review untuk 1 produk", xp: 100, progress: 0, completed: false, icon: Star },
  { id: 3, title: "Belanja UMKM", description: "Beli minimal 3 produk UMKM", xp: 150, progress: 66, completed: false, icon: ShoppingBag },
  { id: 4, title: "Bagikan Produk", description: "Bagikan 2 produk ke social media", xp: 75, progress: 50, completed: false, icon: Share2 },
  { id: 5, title: "Kunjungi Marketplace", description: "Lihat 10 produk di marketplace", xp: 30, progress: 80, completed: false, icon: Eye },
]

const weeklyQuests = [
  { id: 1, title: "Pejuang Belanja", description: "Belanja total Rp 500.000", xp: 500, progress: 45, completed: false, icon: ShoppingBag },
  { id: 2, title: "Reviewer Handal", description: "Berikan 5 review produk", xp: 300, progress: 40, completed: false, icon: Star },
  { id: 3, title: "Petani Rajin", description: "Panen 10 tanaman di Harvest Bogor", xp: 400, progress: 70, completed: false, icon: Sparkles },
]

const badges = [
  { id: 1, name: "Pemula", icon: Medal, unlocked: true, description: "Selesaikan 5 quest pertama" },
  { id: 2, name: "Pembeli Setia", icon: ShoppingBag, unlocked: true, description: "Belanja 10 kali" },
  { id: 3, name: "Reviewer", icon: Star, unlocked: true, description: "Berikan 5 review" },
  { id: 4, name: "Sosialita", icon: Share2, unlocked: false, description: "Bagikan 20 produk" },
  { id: 5, name: "Master Petani", icon: Crown, unlocked: false, description: "Panen 50 tanaman" },
  { id: 6, name: "VIP Member", icon: Trophy, unlocked: false, description: "Capai Level 10" },
]
          ...
          <div className="relative z-10">
            <div className="flex flex-wrap items-center justify-between gap-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h1 className="text-2xl md:text-3xl font-bold text-foreground">Bogor Quest</h1>
                ...
                <Card className="bg-card/80 backdrop-blur border-[#F99912]/20">
                  <CardContent className="p-4 flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xl font-bold text-[#F99912]">{currentXP.toLocaleString()}</p>
                    </div>
                  </CardContent>
                </Card>
              </div>
            ...
            <div className="mt-6">
              <div className="flex justify-between text-sm mb-2">
                ...
                <span className="text-[#F99912]">{currentXP}/{levelXP} XP</span>
              </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-right">
                    ...
                    {quest.completed ? (
                      ...
                      <Button size="sm" className="mt-2 bg-gradient-to-r from-[#F99912] to-[#64762C] text-[#181612]">
                        Klaim
                      </Button>
                    ) : null}
                  </div>
                ...
                >
                  <div className={`w-12 h-12 mx-auto rounded-xl flex items-center justify-center mb-2 ${
                    ...
                    <badge.icon className={`w-6 h-6 ${
                      badge.unlocked ? "text-[#F99912]" : "text-muted-foreground"
                    }`} />
                  </div>
