...
import { 
  ...
  Coins, Trophy, ShoppingBag, Star, Calendar, 
...
export default function ProfilePage() {
  ...
  const [profile, setProfile] = useState({
    ...
    phone: "081234567890",
    address: "Jl. Pajajaran No. 123, RT 01/RW 02, Tegallega, Bogor Tengah, Kota Bogor, Jawa Barat 16143"
  })
                ...
                <div className="flex flex-wrap items-start justify-between gap-4">
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-2">
                      <Badge className="bg-[#F99912] text-[#181612]">Level {stats.level}</Badge>
                      <Badge variant="outline" className="border-[#64762C]/30 text-[#64762C]">Member sejak {stats.memberSince}</Badge>
                    </div>
                  </div>
                  <Button
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between p-3 rounded-xl bg-[#F99912]/10">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm text-foreground">Koin Asli Bogor</span>
                  </div>
                  <span className="font-bold text-[#F99912]">{stats.coins.toLocaleString()}</span>
                </div>
                  ...
                  {achievements.map((achievement) => (
                    ...
                    >
                      <achievement.icon className={`w-6 h-6 mx-auto mb-1 ${
                        achievement.unlocked ? "text-[#F99912]" : "text-muted-foreground"
                      }`} />
