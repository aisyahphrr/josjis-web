...
import { 
  Package, ShoppingCart, TrendingUp, Star, Coins, 
  Eye, ArrowRight, BarChart3, Clock, CheckCircle
} from "lucide-react"
import Link from "next/link"

// Mock data
const stats = [
  { label: "Total Penjualan", value: "Rp 12.5M", icon: Coins, change: "+12% bulan ini", color: "#F99912", up: true },
  { label: "Produk Aktif", value: "24", icon: Package, change: "2 menunggu", color: "#64762C", up: true },
  { label: "Pesanan Baru", value: "15", icon: ShoppingCart, change: "5 hari ini", color: "#3b82f6", up: true },
  { label: "Rating Toko", value: "4.8", icon: Star, change: "156 review", color: "#F99912", up: true },
]

const recentOrders = [
  { id: "ORD-001", customer: "John Doe", product: "Lapis Talas Premium", status: "pending", total: 170000, date: "10 Mar" },
  { id: "ORD-002", customer: "Jane Smith", product: "Roti Unyil x3", status: "processing", total: 105000, date: "10 Mar" },
  { id: "ORD-003", customer: "Ahmad", product: "Kopi Bogor", status: "shipped", total: 75000, date: "9 Mar" },
]
    ...
    <DashboardLayout role="umkm">
      <div className="space-y-8">
        ...
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-[#64762C]/20 via-[#424F17]/10 to-[#F99912]/20 p-6 border border-[#64762C]/20">
          ...
          <div className="relative z-10">
            ...
            <p className="text-muted-foreground mb-4">
              Kelola toko Anda dan tingkatkan penjualan dengan fitur-fitur JOSJIS
            </p>
            <div className="flex flex-wrap gap-3">
              ...
              <Link href="/dashboard/umkm/orders">
                <Button variant="outline" className="border-[#64762C]/30 hover:bg-[#64762C]/10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {stats.map((stat) => (
            <Card key={stat.label} className="bg-card/50 backdrop-blur border-[#64762C]/10 hover:border-[#64762C]/30 transition-all duration-300">
          ...
          <Card className="bg-card/50 backdrop-blur border-[#64762C]/10">
            ...
            <CardContent className="space-y-4">
              <div className="text-center p-6 rounded-xl bg-gradient-to-br from-[#64762C]/20 to-[#F99912]/10">
                ...
                <p className="text-sm text-muted-foreground">1,200 XP / 2,000 XP</p>
              </div>
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  <span className="text-muted-foreground">Benefit saat ini</span>
                </div>
              ...
              <Link href="/dashboard/umkm/academy">
                <Button variant="outline" className="w-full border-[#64762C]/30 hover:bg-[#64762C]/10">
                  Tingkatkan Level
                </Button>
              </Link>
            </CardContent>
            ...
            <div className="space-y-4">
              {topProducts.map((product, idx) => (
                <div key={product.name} className="flex items-center gap-4">
                  ...
                  <p className="font-semibold text-[#64762C]">Rp {(product.revenue / 1000000).toFixed(1)}M</p>
                </div>
              ))}
            </div>
          </CardContent>
