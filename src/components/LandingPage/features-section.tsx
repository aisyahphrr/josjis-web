...
const features = [
  {
    ...
    description:
      "Temukan ribuan produk oleh-oleh khas Bogor dari UMKM terpercaya dengan sistem transaksi aman.",
  ...
  },
  {
    ...
    description:
      "Personal shopping assistant berbasis AI yang membantu menemukan produk sesuai budget dan preferensi.",
  ...
  },
  {
    ...
    description:
      "Game farming digital untuk menanam Talas, Pala, dan Jambu Kristal. Dapatkan Koin Asli Bogor!",
  ...
  },
  {
    ...
    title: "Bogor Quest",
    description:
      "Sistem gamification dengan daily check-in, mystery box, dan leaderboard untuk mendapatkan reward.",
  ...
  },
  {
    ...
    description:
      "Program edukasi digital marketing, branding, dan sertifikasi untuk memajukan UMKM Bogor.",
  ...
  },
  {
    ...
    title: "Driver Lokal",
    description:
      "Pengiriman cepat dengan driver lokal terverifikasi. Tracking real-time dan estimasi akurat.",
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto text-pretty">
            JOSJIS menghadirkan ekosistem lengkap untuk mendukung pertumbuhan
            UMKM Bogor dengan teknologi modern dan pengalaman pengguna terbaik.
          </p>
        </div>
          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className="relative h-full backdrop-blur-xl bg-card/60 border border-[#F99912]/10 rounded-2xl p-6 hover:border-[#F99912]/30 transition-all duration-300 hover:translate-y-[-4px] hover:shadow-[0_20px_40px_rgba(249,153,18,0.1)]">
                {/* Icon */}
                <div
                  className={`w-14 h-14 rounded-xl bg-gradient-to-br ${feature.color} p-0.5 mb-6 group-hover:shadow-[0_0_30px_rgba(249,153,18,0.3)] transition-shadow duration-300`}
                >
