...
export default function ProductDetailView({
  ...
  const { addToCart, toggleWishlist, wishlist, reviews } = useUserStore();
              ...
              <CarouselContent>
                {product.images.map((img) => (
                  <CarouselItem key={img.alt}>
                    <div className="aspect-square rounded-2xl bg-linear-to-br from-[#F99912]/20 to-[#64762C]/20 flex items-center justify-center">
                      {/* Placeholder visual */}
        ...
        <Card className="bg-card/50 backdrop-blur border-[#F99912]/10">
          <CardContent className="p-6 space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-2">
              <Button
                className="flex-1 bg-linear-to-r from-[#F99912] to-[#64762C] text-[#181612] hover:shadow-[0_0_20px_rgba(249,153,18,0.3)]"
            ...
            <TabsContent value="review" className="mt-6 space-y-4">
              {productReviews.length > 0 ? (
                ...
                <p className="text-sm text-muted-foreground">
                  Belum ada ulasan. Setelah pesanan selesai, kamu bisa memberi
                  rating dari menu riwayat.
                </p>
              )}
            </TabsContent>
