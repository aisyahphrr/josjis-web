...
// Utility function for consistent formatting (server and client compatible)
            ...
            <div className="space-y-4">
              <div className="rounded-xl bg-muted/30 p-4 border border-[#F99912]/10">
                ...
                <p className="text-xs text-muted-foreground mt-2">
                  Tanggal: {formatDateTime(selectedOrder.createdAtISO)}
                </p>
              </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="font-medium">
                        Rp {formatCurrency(it.price * it.quantity)}
                      </span>
                    </div>
                  );
                })}
              ...
              <div className="rounded-xl bg-muted/30 p-4 border border-[#F99912]/10 flex items-center justify-between">
                ...
                <span className="text-lg font-bold text-[#F99912]">
                  Rp {formatCurrency(selectedOrder.total)}
                </span>
              </div>
            </div>
          ) : (
