...
import { ArrowRight, ShoppingBag, Store, Sparkles, Zap, Globe, Play } from "lucide-react"
...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      <FloatingCard className="bottom-32 right-[12%] hidden lg:block" delay={1.5}>
        <div className="flex items-center gap-2">
          <div className="flex -space-x-2">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="w-8 h-8 rounded-full bg-gradient-to-br from-[#F99912] to-[#64762C] border-2 border-background" />
            ))}
          </div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#F99912]/10 border border-[#F99912]/20 mb-8 animate-fade-in">
          ...
          <span className="text-sm text-[#F99912] font-medium">Platform UMKM Kreatif #1 di Bogor</span>
        </div>
        ...
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight text-balance">
          ...
          <br />
          <span className="text-muted-foreground text-3xl sm:text-4xl md:text-5xl">Khas Bogor</span>
        </h1>

        {/* Subheadline */}
        <p className="text-lg sm:text-xl text-muted-foreground max-w-3xl mx-auto mb-10 text-pretty">
          Platform digital untuk menemukan, mendukung, dan memajukan UMKM kreatif Bogor 
          melalui marketplace, gamification, dan teknologi AI.
        </p>
        ...
        <div className="flex flex-wrap items-center justify-center gap-3">
          {["E-Commerce", "Gamification", "AI Assistant", "Edukasi Digital"].map((feature) => (
            <div 
              key={feature}
