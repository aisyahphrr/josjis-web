        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#64762C]/10 border border-[#64762C]/20 mb-6">
              ...
              <span className="text-sm text-[#64762C] font-medium">Gamification</span>
            </div>
            ...
            <p className="text-lg text-muted-foreground mb-8 text-pretty">
              ...
              Dapatkan <span className="text-[#F99912] font-semibold">Koin Asli Bogor</span> yang 
              dapat ditukar dengan diskon belanja. 1 koin = Rp1 diskon saat checkout!
            </p>
            ...
            <div className="relative backdrop-blur-xl bg-card/60 border border-[#64762C]/20 rounded-3xl p-6 shadow-[0_20px_60px_rgba(100,118,44,0.2)]">
              ...
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-foreground">Kebun Virtual</h3>
                    <p className="text-sm text-muted-foreground">Level 5 Farmer</p>
                  </div>
                </div>
                <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#F99912]/10 border border-[#F99912]/20">
                  ...
                  <span className="text-sm font-semibold text-[#F99912]">1,250</span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-4 mb-6">
                {plants.map((plant) => (
                  ...
                  >
                    <span className="text-4xl mb-2 group-hover:scale-110 transition-transform">{plant.emoji}</span>
                    <p className="text-xs font-medium text-foreground text-center">{plant.name}</p>
                    <p className="text-[10px] text-muted-foreground">{plant.growthTime}</p>
                    <div className="absolute bottom-2 right-2 flex items-center gap-1 px-1.5 py-0.5 rounded-full bg-[#F99912]/20">
                      ...
                      <span className="text-[10px] font-semibold text-[#F99912]">{plant.reward}</span>
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div className="p-4 rounded-xl bg-muted/30 border border-[#F99912]/10">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm text-muted-foreground">Progress Panen</span>
                  <span className="text-sm font-semibold text-[#F99912]">67%</span>
                </div>
